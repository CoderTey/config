...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/00d14ff8-769d-488d-9242-e99f6287e326";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/9DBD-AC33";
      fsType = "vfat";
  ...
  # networking.interfaces.enp0s20f0u4u3u4.useDHCP = lib.mkDefault true;
