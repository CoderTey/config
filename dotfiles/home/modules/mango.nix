...
exec-once=waybar
exec-once=swaybg -i /home/tey/Pictures/1.jpg
...
maxmizescreencolor=0xA3BE8Cff
urgentcolor=0xBF616Aff
scratchpadcolor=0x4C566Aff
globalcolor=0x81A1C1ff
overlaycolor=0x88C0D0ff
...
# menu and terminal
bind=Alt,R,spawn,rofi -show drun
...
bind=SUPER,T,spawn,bash ~/dotfiles/home/modules/rofi-sessions.sh
bind=SUPER,B,spawn,zsh ~/dotfiles/home/modules/bookmarks-rofi.sh
bind=SUPER,P,spawn,zsh ~/dotfiles/home/modules/repos-rofi.sh
